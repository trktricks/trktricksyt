<html>
<head>
<title><?php $name = str_replace('_', ' ', $_REQUEST["c"]); echo $name; ?> | KAIF JioTV </title>
...
<span style="color:orangered;" class="loading-text-words">I</span>
<span style="color:yellow;" class="loading-text-words">T</span>
<span style="color:white;" class="loading-text-words">z</span>
<span style="color:skyblue;" class="loading-text-words">K</span>
<span  style="color:yellow;" class="loading-text-words">A</span>
<span style="color:hotpink;" class="loading-text-words">I</span>
<span  style="color:yellow;" class="loading-text-words">F</span>
</div>
</div>
